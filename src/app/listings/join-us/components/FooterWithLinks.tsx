          ...
          <Col sm={7} md={6} lg={4}>
            ...
            <ul className="list-inline mb-0 mt-3">
              <li className="list-inline-item me-2">
                <Link href="">
                  <Image alt="" src={paypal} className="h-30px me-1" />
                </Link>
              </li>
              <li className="list-inline-item me-2">
                <Link href="">
                  <Image alt="" src={visa} className="h-30px me-1" />
                </Link>
              </li>
              <li className="list-inline-item me-2">
                <Link href="">
                  <Image alt="" src={mastercard} className="h-30px me-1" />
                </Link>
              </li>
              <li className="list-inline-item me-2">
                <Link href="">
                  <Image alt="" src={expresscard} className="h-30px me-1" />
                </Link>
              </li>
            </ul>
          </Col>
            ...
            <div className="d-lg-flex justify-content-between align-items-center py-3 text-center text-lg-start">
              ...
              <Nav className="nav mt-2 mt-lg-0">
                <ul className="list-inline text-primary-hover mx-auto mb-0">
                  ...
                  <li className="list-inline-item me-0">
                    <NavLink className="text-body-secondary py-1 pe-0" href="/help/detail">
                      Refund policy
                    </NavLink>
                  </li>
                </ul>
