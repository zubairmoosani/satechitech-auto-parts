...
const AvailabilityFilter = () => {
  ...
  return (
    <Row>
      <div className="position-relative mt-n3 mt-xl-n9 col-xl-10">
              ...
              <div className="form-control-border form-control-transparent form-fs-md flex-centered">
                ...
                <div className="w-100">
                  ...
                  <Dropdown className="guest-selector me-2">
                    <DropdownToggle readOnly as="input" className="form-guest-selector form-control selection-result" value={getGuestsValue()} />
