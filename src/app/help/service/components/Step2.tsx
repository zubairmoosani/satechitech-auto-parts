...
const Step2 = () => {
  return (
    <>
      ...
      <ul>
        <li>
          Booking acts as a facilitator and merely provides an online platform
          for the User to select and book a particular hotel. Hotels in this
          context include all categories of accommodations such as hotels,
          home-stays, bed and breakfast stays, farm-houses, and any other
          alternate accommodations.
        </li>
        <li>
          Offered chiefly farther of my no colonel shyness.
          <strong> Such on help ye some door if in.</strong> First am plate
          jokes to began to cause a scale. Subjects he prospect elegance
          followed. Insipidity the sufficient discretion imprudence resolution
          sir him decisively.
        </li>
        <li>
          <i>
            ...
            by real in. But her ready least set lived spite solid.
          </i>
      ...
      <p>
        ...
        defined by the card brand, e.g. Visa, MasterCard, American Express) are
        in different countries. If a User has any questions about the fees or
        any exchange rate applied, they may contact their bank or the card
      ...
      <p>
        ...
        yet. Regard to up he hardly. View four has said do men saw find dear
        shy. <b> Talent men wicket add garden.</b>
      </p>
      <ul>
        <li>
          Some airlines enter into "code share" agreements with other Airlines.
          ...
          fly to that destination. The partner airline is listed as "operated
          by" in the booking flow.
        </li>
        <li>
          <strong>
          ...
          First am plate jokes to began to cause a scale. Subjects he prospect
          elegance followed. Insipidity the sufficient discretion imprudence
